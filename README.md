# Combination with Ship Environment
DQN implementation for ship environment developed by pygame library.

## Before training
![before training](https://i.imgur.com/peDX9o4.gif)

## After training
![after training](https://i.imgur.com/2HVCptx.gif)
